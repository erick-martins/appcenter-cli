...
/**
 * Class representing a BranchConfigurationToolsetsDistribution.
 */
class BranchConfigurationToolsetsDistribution {
  /**
  ...
  /**
   * Defines the metadata of BranchConfigurationToolsetsDistribution
   *
   * @returns {object} metadata of BranchConfigurationToolsetsDistribution
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'BranchConfiguration_toolsets_distribution',
      type: {
        name: 'Composite',
...
module.exports = BranchConfigurationToolsetsDistribution;
